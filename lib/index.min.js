'use strict';var _extends=Object.assign||function(a){for(var b,c=1;c<arguments.length;c++)for(var d in b=arguments[c],b)Object.prototype.hasOwnProperty.call(b,d)&&(a[d]=b[d]);return a};Object.defineProperty(exports,'__esModule',{value:!0});exports.initializeStore=initializeStore,exports.getStore=getStore,exports.updateStore=updateStore,exports.addObserver=addObserver;/** @format */var observers=[],store={},persistedStateKeys=null,persistStorage=null,persistTimeout=null;function initializeStore(a){if(observers=[],store={},persistedStateKeys=null,persistStorage=null,persistTimeout=null,void 0!==a.persist){// persist
var b={};// set the storage first
persistStorage=a.persist.storage,b=a.persist.restore(JSON.parse(persistStorage.getItem('fluxible-js'))||{}),persistedStateKeys=Object.keys(b),Object.keys(a.initialStore).forEach(function(c){store[c]=-1===persistedStateKeys.indexOf(c)?a.initialStore[c]:b[c]})}else Object.keys(a.initialStore).forEach(function(b){store[b]=a.initialStore[b]})}function getStore(){return _extends({},store)}function updateStore(a){null!==persistedStateKeys&&(null!==persistTimeout&&clearTimeout(persistTimeout),persistTimeout=setTimeout(function(){persistStorage.setItem('fluxible-js',JSON.stringify(persistedStateKeys.reduce(function(a,b){return a[b]=store[b],a},{})))},200));var b=Object.keys(a);// only notify observers that observes the store keys that were updated
